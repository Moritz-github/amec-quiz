...
from app.questions.question_pools import pool_amec, pool_chemistry
...
def index():
    ...
    return render_template("index.html", title="Willkommen!", question_pool = question_pools.keys())
...
def quiz():
    ...
    return render_template("quiz.html", title="Frage")
